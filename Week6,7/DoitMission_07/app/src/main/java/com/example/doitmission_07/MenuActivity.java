...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        else if(resultCode == CUSTOMER_CODE_FROM_MENU) {
            Toast.makeText(getApplicationContext(),"고객 관리를 선택했습니다",Toast.LENGTH_LONG).show();
        }
        else if(resultCode == SALES_CODE_FROM_MENU) {
            Toast.makeText(getApplicationContext(),"매출 관리를 선택했습니다",Toast.LENGTH_LONG).show();
        }
        else if(resultCode == PRODUCT_CODE_FROM_MENU) {
            Toast.makeText(getApplicationContext(),"상품 관리를 선택했습니다",Toast.LENGTH_LONG).show();
        }
